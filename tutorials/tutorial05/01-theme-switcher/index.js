...
document.getElementById("default").addEventListener("click", () => changeClass(""));
document.getElementById("desert").addEventListener("click", () => changeClass("desert"));
document.getElementById("ocean").addEventListener("click", () => changeClass("ocean"));
document.getElementById("high-contrast").addEventListener("click", () => changeClass("high-contrast"));
